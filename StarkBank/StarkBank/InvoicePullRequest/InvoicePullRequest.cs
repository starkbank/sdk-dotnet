...
namespace StarkBank
{
    ...
    /// <br/>
    /// Properties:
    ///     <item>SubscriptionID [string]: Unique of the InvoiceSubscription related to the invoice. ex: "5656565656565656"
    ...
    ///     <item>Status [string]: current InvoicePullRequest status. ex: "pending", "scheduled", "success", "failed", "canceled"
    ///     <item>BacenID [string]: unique authentication id at the Central Bank. ex: "ccf9bd9c-e99d-999e-bab9-b999ca999f99"
    ...
    public partial class InvoicePullRequest : Resource
    {
        ...
        /// </list>
        /// </summary>
        public InvoicePullRequest(string id = null, string subscriptionId = null, string invoiceId = null, DateTime? due = null, string attemptType = null, List<string> tags = null, string externalId = null, string displayDescription = null, string status = null, string bacenId = null, string installmentId = null, DateTime? created = null, DateTime? updated = null)
            : base(id)
        {
        ...
        /// Return:
        /// <list>
        ///     <item>list of InvoicePullRequest objects with updated attributes and cursor to retrieve the next page of Boleto objects</item>
