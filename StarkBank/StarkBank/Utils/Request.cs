...
namespace StarkBank.Utils
{
    ...
    internal static class Request
    {
        ...
        internal static Response Fetch(HttpMethod method, string path, Dictionary<string, object> payload = null, Dictionary<string, object> query = null, User user = null)
        {
            string url = "";
            ...
            string agent = ".NET-" + Environment.Version.ToString() + "-SDK-2.0.0";
