...
namespace StarkBank
{
    ...
    public partial class CorporateRule : Resource
    {
        ...
        /// </list>
        /// </summary>
        public CorporateRule(string name, long amount, string interval, string schedule = null, string currencyCode = "BRL", 
        ...
        internal static Resource ResourceMaker(dynamic json)
        {
            ...
            return new CorporateRule(
                id: id, name: name, amount: amount, interval: interval, schedule: schedule, currencyCode: currencyCode, 
