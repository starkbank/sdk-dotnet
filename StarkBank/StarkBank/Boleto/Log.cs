...
namespace StarkBank
{
    public partial class Boleto
    {
        ...
        ///     <item>Created [DateTime]: creation datetime for the boleto. ex: DateTime.new(2020, 3, 10, 10, 30, 0, 0)</item>
        /// </list>
        /// </summary>
        public class Log : Utils.Resource
        {
            ...
            ///     <item>boletoIds [list of strings, default nil]: list of Boleto ids to filter logs. ex: ["5656565656565656", "4545454545454545"]</item>
            ///     <item>types [list of strings, default nil]: filter for log event types. ex: "paid" or "registered"</item>
