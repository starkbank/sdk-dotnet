...
namespace StarkBank
{
    ...
    ///     <item>Source [string, default nil]: locator of the entity that generated the transaction. ex: "charge/1827351876292", "transfer/92873912873/chargeback"</item>
    ///     <item>ID [string, default nil]: unique id returned when Transaction is created. ex: "7656565656565656"</item>
    ///     <item>Fee [integer, default nil]: fee charged when transfer is created. ex: 200 (= R$ 2.00)</item>
    ///     <item>Created [DateTime, default nil]: creation datetime for the boleto. ex: DateTime.new(2020, 3, 10, 10, 30, 0, 0)</item>
    /// </list>
    /// </summary>
    public class Transaction : Utils.Resource
    {
        ...
        ///     <item>externalIds [list of strings, default nil]: list of external ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]</item>
        ///     <item>after [Date, default nil] date filter for objects created only after specified date. ex: Date.new(2020, 3, 10)</item>
        ///     <item>before [Date, default nil] date filter for objects created only before specified date. ex: Date.new(2020, 3, 10)</item>
