...
namespace StarkBank
{
    public partial class DasPayment
    {
        /// <summary>
        ...
        ///     <item>Payment [DasPayment]: DasPayment entity to which the log refers to.</item>
        ///     <item>Errors [list of strings]: list of errors linked to this DasPayment event.</item>
        ///     <item>Type [string]: type of the DasPayment event which triggered the log creation. ex: "processing" or "success"</item>
        ...
        public class Log : Utils.Resource
        {
            ...
            /// </list>
            /// </summary>
            public Log(string id, DateTime created, string type, List<string> errors, DasPayment payment) : base(id)
            {
                Created = created;
                Type = type;
                Errors = errors;
            ...
            ///     <item>paymentIds [list of strings, default null]: list of DasPayment ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]</item>
            ...
            {
                return (resourceName: "DasPaymentLog", resourceMaker: ResourceMaker);
            }
            ...
            internal static Utils.Resource ResourceMaker(dynamic json)
            {
                ...
                DasPayment payment = DasPayment.ResourceMaker(json.payment);
