...
namespace StarkBank
{
    ...
    ///     <item>Fee [integer, default null]: fee charged when DasPayment is created. ex: 200 (= R$ 2.00)</item>
    ///     <item>Created [DateTime, default null]: creation datetime for the payment. ex: DateTime.new(2020, 3, 10, 10, 30, 0, 0)</item>
    /// </list>
    /// </summary>
    public partial class DasPayment : Utils.Resource
    {
        ...
        /// </list>
        /// </summary>
        public DasPayment(string description, string id = null, long? amount = null, string line = null,
        ...
        /// Parameters (required):
        /// <list>
        ///     <item>payments [list of DasPayment objects]: list of DasPayment objects to be created in the API</item>
        /// </list>
        /// <br/>
        /// Parameters (optional):
        /// <list>
        ...
        /// Return:
        /// <list>
        ///     <item>list of DasPayment objects with updated attributes</item>
        /// </list>
        /// </summary>
        public static List<DasPayment> Create(List<DasPayment> payments, User user = null)
        {
            ...
            return Utils.Rest.Post(
                ...
                entities: payments,
                user: user
            ).ToList().ConvertAll(o => (DasPayment)o);
        }
        ...
        /// Parameters (required):
        /// <list>
        ///     <item>payments [list of Dictionaries]: list of Dictionaries representing the DasPayments to be created in the API</item>
        /// </list>
        /// <br/>
        /// Parameters (optional):
        /// <list>
        ...
        /// </list>
        /// </summary>
        public static List<DasPayment> Create(List<Dictionary<string, object>> payments, User user = null)
        {
            (string resourceName, Utils.Api.ResourceMaker resourceMaker) = Resource();
            return Utils.Rest.Post(
                resourceName: resourceName,
        ...
        /// Return:
        /// <list>
        ///     <item>DasPayment object with updated attributes</item>
        /// </list>
        /// </summary>
        public static DasPayment Get(string id, User user = null)
        {
            (string resourceName, Utils.Api.ResourceMaker resourceMaker) = Resource();
        ...
        /// <br/>
        /// Receive an IEnumerable of DasPayment objects previously created in the Stark Bank API
        /// <br/>
        /// Parameters (optional):
        /// <list>
        ...
        /// Return:
        /// <list>
        ///     <item>IEnumerable of DasPayment objects with updated attributes</item>
        /// </list>
        /// </summary>
        public static IEnumerable<DasPayment> Query(int? limit = null, DateTime? after = null, DateTime? before = null,
        ...
        /// Parameters (required):
        /// <list>
        ///     <item>id [string]: DasPayment unique id. ex: "5656565656565656"</item>
        /// </list>
        /// <br/>
        /// Parameters (optional):
        /// <list>
        ...
        /// Return:
        /// <list>
        ///     <item>deleted DasPayment with updated attributes</item>
        /// </list>
        /// </summary>
        public static DasPayment Delete(string id, User user = null)
        {
            (string resourceName, Utils.Api.ResourceMaker resourceMaker) = Resource();
        ...
        {
            return (resourceName: "DasPayment", resourceMaker: ResourceMaker);
        }
