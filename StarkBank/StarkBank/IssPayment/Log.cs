...
namespace StarkBank
{
    public partial class IssPayment
    {
        /// <summary>
        ...
        ///     <item>Payment [IssPayment]: IssPayment entity to which the log refers to.</item>
        ///     <item>Errors [list of strings]: list of errors linked to this IssPayment event.</item>
        ///     <item>Type [string]: type of the IssPayment event which triggered the log creation. ex: "processing" or "success"</item>
        ...
        public class Log : Utils.Resource
        {
            ...
            /// </list>
            /// </summary>
            public Log(string id, DateTime created, string type, List<string> errors, IssPayment payment) : base(id)
            {
                Created = created;
                Type = type;
                Errors = errors;
            ...
            ///     <item>paymentIds [list of strings, default null]: list of IssPayment ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]</item>
            ...
            {
                return (resourceName: "IssPaymentLog", resourceMaker: ResourceMaker);
            }
            ...
            internal static Utils.Resource ResourceMaker(dynamic json)
            {
                ...
                IssPayment payment = IssPayment.ResourceMaker(json.payment);
