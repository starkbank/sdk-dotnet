...
namespace StarkBank
{
    ...
    public partial class Invoice : Resource
    {
        ...
        internal new Dictionary<string, object> ToJson()
        {
            ...
            json["Due"] = new StarkDateTime((DateTime) json["Due"]);
            return json;
        }
        ...
        {
            (string resourceName, Api.ResourceMaker resourceMaker) = Resource();
            (string subResourceName, Api.ResourceMaker subResourceMaker) = InvoicePayment.SubResource();
        ...
        internal static Resource ResourceMaker(dynamic json)
        {
            ...
            foreach (Dictionary<string, object> discount in discounts) {
                discount["due"] = Checks.CheckDateTime((string)discount["due"]);
            }
