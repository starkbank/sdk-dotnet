...
namespace StarkBank
{
    ...
    ///     <item>Tags [list of strings, default null]: list of strings for reference when searching Transactions (may be empty). ex: ["abc", "test"]</item>
    ///     <item>SenderID [string]: unique id of the sending workspace. ex: "5656565656565656"</item>
    ///     <item>Source [string]: locator of the entity that generated the Transaction. ex: "charge/1827351876292", "transfer/92873912873/chargeback"</item>
    ///     <item>ID [string]: unique id returned when Transaction is created. ex: "7656565656565656"</item>
    ///     <item>Fee [integer]: fee charged when Transaction is created. ex: 200 (= R$ 2.00)</item>
    ///     <item>Balance [long integer]: account balance after Transaction was processed. ex: 100000000 (= R$ 1,000,000.00)</item>
    ...
    public class Transaction : Resource
    {
        ...
        /// <list>
        ///     <item>senderID [string]: unique id of the sending workspace. ex: "5656565656565656"</item>
        ///     <item>source [string]: locator of the entity that generated the Transaction. ex: "boleto/1827351876292", "transfer/92873912873/chargeback"</item>
        ///     <item>id [string]: unique id returned when Transaction is created. ex: "7656565656565656"</item>
        ///     <item>fee [integer]: fee charged when Transaction is created. ex: 200 (= R$ 2.00)</item>
        ///     <item>balance [long integer]: account balance after Transaction was processed. ex: 100000000 (= R$ 1,000,000.00)</item>
        ///     <item>created [DateTime]: creation datetime for the Transaction. ex: new DateTime(2020, 3, 10, 10, 30, 0, 0)</item>
        ...
        /// </list>
        /// </summary>
        [Obsolete("Function deprecated since 2.17.0")]
        public static List<Transaction> Create(List<Transaction> transactions, User user = null)
        {
            throw new Exception("Function deprecated since 2.17.0");
        }
        ...
        /// <br/>
        /// Return:
        ///     <item>list of Transaction objects with updated attributes and cursor to retrieve the next page of Transaction objects</item>
        /// </summary>
