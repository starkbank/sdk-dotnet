...
namespace StarkBank
{
    public partial class TaxPayment
    {
        ...
        ///     <item>Payment [TaxPayment]: TaxPayment entity to which the log refers to.</item>
        ///     <item>Errors [list of strings]: list of errors linked to this TaxPayment event.</item>
        ///     <item>Type [string]: type of the TaxPayment event which triggered the log creation. ex: "processing" or "success"</item>
        ...
        public class Log : Resource
        {
            ...
            /// </list>
            /// </summary>
            public Log(string id, DateTime created, string type, List<string> errors, TaxPayment payment) : base(id)
            {
                Created = created;
                Type = type;
                Errors = errors;
            ...
            ///     <item>paymentIds [list of strings, default null]: list of TaxPayment ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]</item>
            ...
            {
                return (resourceName: "TaxPaymentLog", resourceMaker: ResourceMaker);
            }
            ...
            internal static Resource ResourceMaker(dynamic json)
            {
                ...
                TaxPayment payment = TaxPayment.ResourceMaker(json.payment);
