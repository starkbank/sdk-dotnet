...
namespace StarkBank
{
    ...
    /// <br/>
    /// Properties:
    ///     <item>Start [DateTime or string]: subscription start date in UTC ISO format. ex: "2022-04-01"</item>
    ///     <item>Interval [string]: subscription installment interval. Options: "week", "month", "quarter", "semester", "year"</item>
    ///     <item>PullMode [string]: subscription pull mode. Options: "manual", "automatic". Automatic mode will create the Invoice Pull Requests automatcally</item>
    ...
    ///     <item>ExternalID [string, default None]: string that must be unique among all your InvoicePullSubscriptions. Duplicated external_ids will cause failures. ex: "my-external-id"</item>
    ///     <item>ReferenceCode [string, default None]: reference code for reconciliation. ex: "REF123456"</item>
    ///     <item>End [DateTime or string, default None]: subscription end date in UTC ISO format. ex: "2023-04-01"</item>
    ...
    ///     <item>ID [string]: unique id returned when InvoicePullSubscription is created. ex: "5656565656565656"</item>
    ///     <item>Status [string]: current InvoicePullSubscription status. ex: "active", "canceled"</item>
    ///     <item>BacenID [string]: unique authentication id at the Central Bank. ex: "ccf9bd9c-e99d-999e-bab9-b999ca999f99"</item>
    ///     <item>Created [DateTime]: creation DateTime for the InvoicePullSubscription. ex: DateTime(2020, 3, 10, 10, 30, 0, 0)</item>
    ///     <item>Updated [DateTime]: latest update DateTime for the InvoicePullSubscription. ex: DateTime(2020, 3, 10, 10, 30, 0, 0)</item>
    /// </list>
    /// </summary>
    public partial class InvoicePullSubscription : Resource
    {
        ...
        /// Return:
        /// <list>
        ///     <item>list of InvoicePullSubscription objects with updated attributes and cursor to retrieve the next page of Boleto objects</item>
        ...
        /// Parameters(required):
        /// <list>
        ///     <item>id[string]: InvoicePullSubscription unique id. ex: "5656565656565656"</item>
        /// </list>
        /// <br/>
        /// Parameters(optional):
        /// <list>
