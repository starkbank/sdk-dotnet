...
StarkBank`s .NET SDK is available on NuGet as starkbank 2.15.1.

1.1 To install the Package Manager:

```sh
Install-Package starkbank -Version 2.15.1
```

1.2 To install the .NET CLI:

```sh
dotnet add package starkbank --version 2.15.1
```
...
```sh
paket add starkbank --version 2.15.1
```
