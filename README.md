...
StarkBank`s .NET SDK is available on NuGet as starkbank 2.17.0.

1.1 To install the Package Manager:

```sh
Install-Package starkbank -Version 2.17.0
```

1.2 To install the .NET CLI:

```sh
dotnet add package starkbank --version 2.17.0
```

1.3 To install by PackageReference:

```sh
<PackageReference Include="starkbank" Version="2.17.0" />
```

1.4 To install with Paket CLI:

```sh
paket add starkbank --version 2.17.0
```
